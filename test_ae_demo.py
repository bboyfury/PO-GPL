    ...
    def evaluate_demo_episode(self, action_shape, model, cg_model, true_state_directory):
        ...
        for j in range(self.config["num_eval_episodes"]):
            ...
            for k in range(1,dim_test): 
                ...
                # buff_agent_existence_log_prob = out["others"]["agent_existence_log_prob"].detach().cpu().numpy()
                ...
                # print(out["others"]["state_reconstruction_log_prob"].detach().numpy(), existence_difference.detach().cpu().numpy())
